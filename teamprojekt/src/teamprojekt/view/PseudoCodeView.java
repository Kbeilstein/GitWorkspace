...
public class PseudoCodeView extends JFrame
{
    ...
    private String codeLS = ""
        ...
        + " while(array[position] != 0 && index == -1)"                 + "\t\t\t\t\t"                      + "// suche bis leere Zelle oder noch nicht gefunden"   + "\n\t"
        ...
        + cutS 
        + " Einf\u00fcgen:"                                             + "\n"
        + " if(!arrayVoll && suche(wert)==-1)"                          + "\t\t\t\t\t\t\t"                  + "// ist Array nicht voll und Wert nicht gefunden"     + "\n\t"
            + " int position =  wert % arraylaenge;"                    + "\t\t\t\t\t\t"                    + "// Anfangsposition / h0"                             + "\n\t"
            + " int i= 1;"                                              + "\t\t\t\t\t\t\t\t\t\t\t\t\t"      + "// Wert um den verschoben wird"                      + "\n\t"
            + " while(array[position] != 0 && array[position] != -1)"   + "\t\t"                            + "// suche bis leere Zelle oder als geloescht markiert" + "\n\t\t"
                        + " position = ((wert % arraylaenge) + i) % arraylaenge;" + "\t"                    + "// naechste Position / hX"               + "\n\t\t"
                        + " i++;"                                       + "\t\t\t\t\t\t\t\t\t\t\t\t"        + "// verschiebe um 1"                      + "\n"
    ...
    private String codeErwLS = ""
        ...
        + cutS 
        + " Einf\u00fcgen:"                                             + "\n"
        + " if(!arrayVoll && suche(wert)==-1)"                          + "\t\t\t\t\t\t\t"                  + "// ist Array nicht voll oder Wert nicht gefunden"     + "\n\t"
            + " int position =  wert % arraylaenge;"                    + "\t\t\t\t\t\t"                    + "// Anfangsposition / h0"                             + "\n\t"
            + " int i= 1;"                                              + "\t\t\t\t\t\t\t\t\t\t\t\t\t"      + "// Wert um den verschoben wird"                      + "\n\t"
            + " int c = {z.B.: 3,5,7};"                                 + "\t\t\t\t\t\t\t\t\t\t"            + "// waehle ein c welches teilerfremd mit Arraylaenge"  + "\n"
            + " while(array[position] != 0 && array[position] != -1 "   + "\t\t\t"                          + "// suche bis leere Zelle oder als geloescht markiert" + "\n\t\t"
    ...
    private String codeAltQS = ""
        ...
        + " if(!arrayVoll && suche(wert)==-1)"                          + "\t\t\t\t\t\t\t"                  + "// ist Array nicht voll und Wert nicht gefunden"     + "\n\t"
            ...
            + "     && i <= arraylaenge)"                               + "\t\t\t\t\t\t\t\t"                + "// oder bis einmal durch Array gelaufen"             + "\n\t\t"
                ...
                + " else"                                               + "\t\t\t\t\t\t\t\t\t\t\t\t"        + "// oder -"                               + "\n\t\t\t"
                    + " position = ((wert % arraylaenge) - (j * j)) % arraylaenge"   + "\t"                              + "// naechste Position / hX"               + "\n\t\t\t\t"
                    + "     + arrayLength) % arrayLength;"              + "\t\t\t"                          + "// Zusatz zum Abfangen einer negativen Position"     + "\n\t\t\t"
                    + " j++;"                                           + "\t\t\t\t\t\t\t\t\t\t\t"          + "// verschiebe um 1"                      + "\n"
            + " array[position] = wert;"                                + "\t\t\t\t\t\t\t\t\t\t"            + "// fuege den Wert ein"                   + "\n";
    ...
    private String codeDH = ""
        ...
        + " while(array[position] != 0 && index == -1)"                 + "\t\t\t\t\t"                      + "// suche bis leere Zelle oder noch nicht gefunden"   + "\n\t"
            ...
            + "     - i * (1 + wert % (arraylaenge - 2))) % arraylaenge "   + "\t"                          + "// hier geht es weiter / hX"                         + "\n\t\t"
            + "     + arraylaenge) % arraylaenge;"                          + "\t\t\t\t\t"                      + "// Zusatz zum Abfangen einer negativen Position"     + "\n\t\t"
            + " i++;"                                                   + "\t\t\t\t\t\t\t\t\t\t\t\t"        + "// verschiebe um 1"                                  + "\n"
        + " return index;"                                              + "\t\t\t\t\t\t\t\t\t\t\t\t"        + "// Rueckgabe: Wert gefunden oder nicht gefunden"     + "\n"
        + cutS 
        + " Einf\u00fcgen:"                                             + "\n"
